...
export function sumArrayWithThreeNumbers(sumArr) {
    ...
    const sum2Array = sum(numArray[0], numArray[1])[0];
    const sumArray3 = sum(sum2Array, numArray[2])[0];
    return [sumArray3, `2,3,4 was passed in as an array of numbers, and ${sumArray3} is their sum.`];
}
...
export function multiplyArrayWithThreeNumbers(multArr) { //eslint-disable-line
    ...
    const mult2Array = multiply(multArray[0], multArray[1])[0];
    const mult3Array = multiply(mult2Array, multArray[2])[0];
    return [mult3Array, `The numbers 2,3,4 have a product of ${mult3Array}.`];
}
...
//     const newProduct = multiply(dynamicArray[i], product)[0];
//     product = newProduct;
// }
// Once you get the test passing, do an a-c-p cycle and synchronize the code between GitHub and your laptop. 
